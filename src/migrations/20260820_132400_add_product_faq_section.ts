...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    ALTER TABLE "products" DROP COLUMN IF EXISTS "show_general_faq";
    ALTER TABLE "_products_v" DROP COLUMN IF EXISTS "version_show_general_faq";
    DROP TABLE IF EXISTS "product_faq_section_items" CASCADE;
    DROP TABLE IF EXISTS "product_faq_section_feature_icons" CASCADE;
    DROP TABLE IF EXISTS "product_faq_section" CASCADE;
    DROP TYPE IF EXISTS "public"."enum_product_faq_section_feature_icons_icon";
  `)
}
